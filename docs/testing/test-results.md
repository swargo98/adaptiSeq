...
Last updated: 2026-06-28 11:04 CDT
...
| OFF-02 | Segmented engine and finalize behavior | Passed | 2026-06-27 | Conda `adaptiseq` | `tests/test_segmented.py tests/test_segmented_finalize.py` passed: 23 passed. | User-reported terminal output. |
| OFF-03 | Native FTP segmented path | Passed | 2026-06-27 | Conda `adaptiseq` | `tests/test_ftp_segmented.py` passed: 3 passed. | User-reported terminal output. |
| OFF-04 | Batch/adaptive primitives | Passed | 2026-06-27 | Conda `adaptiseq` | `tests/test_batch.py tests/test_meter_gate.py tests/test_optimize.py` passed: 22 passed. | Codex-run pytest output; includes worker-cap and success-log regression coverage. |
...
| OFF-07 | Aspera batch/controller primitives | Passed | 2026-06-27 | Conda `adaptiseq` | `tests/test_aspera.py` passed: 12 passed. | Codex-run pytest output; includes worker-cap, success-log skip, retry, directory meter, and hysteresis coverage. |
...
| TC-14 | SRA to FASTQ Conversion | Not Run |  |  |  | Requires `srapath`, `fasterq-dump`, `vdb-validate`, and `pigz`. |
| TC-15 | Merge by Experiment | Not Run |  |  |  | Network/download dependent. |
| TC-16 | Merge Guard Negative Case | Not Run |  |  |  | Expected non-zero exit before download. |
